...
import com.tuckman.advent.of.code.twenty.day.l.DataMasker;
import com.tuckman.advent.of.code.twenty.day.l.DataMaskerV2;
...
class DataMaskerTest {
    ...
    void test_exampleInput() {
        ...
        List<String> exampleInput = AdventUtils.listLinesOfResource("twenty/exampleMasks.txt");
    ...
    void test_actualInput() {
        DataMasker dataMasker = new DataMasker();
        List<String> actualInput = AdventUtils.listLinesOfResource("twenty/masks.txt");
    ...
    void test_exampleInput_v2() {
        ...
        List<String> exampleInput = AdventUtils.listLinesOfResource("twenty/exampleMasks2.txt");
        long result = dataMasker.sumAllDataFrom(exampleInput);
        System.out.println("Example result: " + result);
