...
class AdapterArrayTest {
    ...
    void test_exampleInput1_differences() {
        Stream<String> exampleInput = AdventUtils.streamLinesOfResource("exampleAdapter.txt");
    ...
    void test_exampleInput2_differences() {
        Stream<String> exampleInput = AdventUtils.streamLinesOfResource("exampleAdapter2.txt");
        long diffs = adapterArray.numberOfDifferences(exampleInput);
    ...
    void test_actualInput_differences() {
        Stream<String> actualInput = AdventUtils.streamLinesOfResource("adapter.txt");
