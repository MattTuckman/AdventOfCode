...
class ValidTicketTest {
    ...
    void test_exampleInput() {
        List<String> exampleInput = AdventUtils.listLinesOfResource("exampleTickets.txt");
    ...
    void test_actualInput() {
        List<String> actualInput = AdventUtils.listLinesOfResource("tickets.txt");
    ...
    void test_exampleInput_findFields() {
        List<String> exampleInput = AdventUtils.listLinesOfResource("exampleTickets2.txt");
